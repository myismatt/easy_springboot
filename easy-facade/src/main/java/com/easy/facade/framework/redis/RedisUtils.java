...
public class RedisUtils {
     ...
     * @param message 消息
     */
    public void pushListenerMessage(String channel, Object message) {
     ...
     * 获取订阅发布的消息
     *
     * @param getBody getBody
     * @return Object
     */
    public Object getListenerMessage(byte[] getBody) {
        return redisTemplate.getValueSerializer().deserialize(getBody);
    }
}
